...
class EmployeeAuthorCanEditPermission(SafeMethodsOnlyPermission):
    ...
    def has_object_permission(self, request, view, obj=None):
        ...
        return can_edit or super(EmployeeAuthorCanEditPermission, self).has_object_permission(request, view, obj)
